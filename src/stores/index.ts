...
import { exerciseStore, ExerciseStore } from './ExerciseStore';
...
export const useExerciseStore = () => useContext(StoreContext).exerciseStore;
...
export { authStore, workoutStore, exerciseStore, weightStore, stepsStore, settingsStore };
export type { AuthStore } from './AuthStore';
export type { WorkoutStore } from './WorkoutStore';
export type { ExerciseStore } from './ExerciseStore';
